...
private var robotUpperArmXRot : float;
public var robotUpperArmXRotMin : float = -45f;
public var robotUpperArmXRotMax : float = 45f;
...
RobotUpperArm.eulerAngles = new Vector3(robotUpperArmXRot, RobotUpperArm.eulerAngles.y, RobotUpperArm.eulerAngles.z);
